...
export const zhTranslations = {
  ...
  settings: {
    ...
    modelAccess: {
      ...
      privacyDisclosure:
        "捕获、本地存储与关键词搜索完全在本机完成。AI 功能（摘要、探索、向量化、提示词工具、圆桌）会把相关对话文本发送给所配置的模型 —— 默认经 Vesti 代理转发至阿里云百炼。填入你自己的 API Key 即可直连。",
      ...
      whitelistOnly: "仅白名单",
      proxy: "代理",
      proxyDesc: "Demo 聊天与向量请求统一经 Vesti 网关。网关使用 qwen-plus，并在服务端管理 qwen-turbo 回退；旧网关仅用于可重试的网络或服务故障。",
      proxyChat: "代理聊天",
      proxyRoute: "路由",
      proxyBaseUrl: "基础地址",
      proxyHeader: "请求头",
...
>>>>>>> origin/main
    ...
    desktop: {
      title: "连接 VESTI 桌面",
      description: "与桌面端配对，把记忆库同步到这台电脑。",
      statusLabel: "状态",
      statusOnline: "桌面端在线",
      statusOffline: "桌面端离线",
      statusNotPaired: "未配对",
      statusNeedsRepair: "需要重新配对",
      pairedAt: "配对时间",
      lastSync: "上次同步",
      neverSynced: "从未同步",
      syncing: "同步中…",
      codeLabel: "配对码",
      codePlaceholder: "桌面端显示的 6 位配对码",
      codeInvalid: "配对码无效或已过期。",
      desktopOffline: "未检测到桌面端。请先启动 VESTI 桌面端再试。",
      desktopIncompatible: "桌面端桥接协议版本不兼容，请更新桌面端。",
      pairFailed: "配对失败，请重试。",
      connect: "连接",
      connecting: "连接中…",
      disconnect: "断开连接",
      disconnected: "已断开与 VESTI 桌面端的连接。",
      syncNow: "立即同步",
      syncResult: "已推送 {conversations} 个会话 · {messages} 条消息",
      syncSkipped: "没有需要同步的新内容。",
    ...
    relay: {
      ...
      injecting: "注入中…",
      dismiss: "忽略",
      injected: "已填充到当前标签页的输入框，请在页面中确认后发送。",
      empty: "暂无待注入的交接包。",
  ...
  dashboard: {
    ...
    library: {
      ...
      noSmartClassification: "分析对话后，智能分类会显示在这里。",
      organizeUnclassified: "整理未分类",
      organizeUnclassifiedConfirm: "将分析接下来的 {count} 条未分类对话，是否继续？",
      organizingConversations: "整理中 {done}/{total}",
      classificationComplete: "已整理 {done} 条对话。",
      classificationPartial: "已整理 {done} 条，{failed} 条失败。",
      tags: "标签",
      folders: "文件夹",
      myNotes: "我的笔记",
      exporting: "正在导出...",
      ...
      weeklyKnowledge: "每周知识沉淀",
      weeklyKnowledgeNote: "周报知识笔记",
      generatedFromWeeklyReport: "由个人成长周报生成",
      noWeeklyKnowledgeYet: "在个人成长周报中沉淀笔记，逐周建立你的知识档案",
    ...
    aiti: {
      ...
      insufficientHint: "当你有 2 段以上对话时，AITI 就会显示一份初步画像。",
      sample: "来自你的 {n} 段对话",
      confidenceLabel: "置信度",
      confidenceLow: "初步",
      confidenceMedium: "逐渐成形",
      confidenceHigh: "较为可靠",
      typeSeparator: " · ",
      ...
      axisCuriosityLabel: "落定 ↔ 好奇",
      axisCuriosityLeft: "落定型",
      axisCuriosityRight: "好奇型",
      axisCuriosityLeftStrength: "你讲究效率，倾向于快速得到答案。",
      axisCuriosityRightStrength: "你自由发问，喜欢顺着线索一路追下去。",
      axisInterdisciplinaryLabel: "专注 ↔ 跨界",
    ...
    learn: {
      ...
      learningPathTitle: "建议学习路径",
      learningPathStage: "第 {n} 阶段",
      learningPathEstimatedMinutes: "约 {n} 分钟",
      reviewQueueTitle: "待复习",
      reviewQueueEmpty: "当前没有到期的复习项。",
      reviewDueNow: "现在复习",
      reviewDueSoon: "即将到期",
      goalsTitle: "学习目标",
      goalsEmpty: "尚未推断出目标 —— 多聊一些后会出现。",
      learningPathFoundationTitle: "建立 {domain} 基础",
      learningPathExpandTitle: "连接 {domains}",
