export const koTranslations = {
  ...
  settings: {
    ...
    modelAccess: {
      ...
      endpoint: "엔드포인트",
      credentials: "자격 증명",
      apiKeyLabel: "API 키 (Chat)",
      apiKeyPlaceholder: "sk-...",
      modelLabel: "모델",
      whitelistOnly: "화이트리스트 전용",
      proxy: "프록시",
      proxyDesc: "Demo 채팅과 임베딩은 Vesti 게이트웨이를 사용합니다. qwen-plus 및 qwen-turbo 폴백은 게이트웨이에서 관리하며, 기존 게이트웨이는 재시도 가능한 네트워크 또는 서버 장애에만 사용됩니다.",
      proxyChat: "프록시 채팅",
      proxyRoute: "경로",
      proxyBaseUrl: "기본 URL",
      proxyHeader: "헤더",
  ...
  dashboard: {
    ...
    library: {
      ...
      noSmartClassification: "대화를 분석하면 스마트 분류가 여기에 표시됩니다.",
      organizeUnclassified: "미분류 정리",
      organizeUnclassifiedConfirm: "다음 미분류 대화 {count}개를 분석할까요?",
      organizingConversations: "정리 중 {done}/{total}",
      classificationComplete: "대화 {done}개를 정리했습니다.",
      classificationPartial: "{done}개를 정리했고 {failed}개는 실패했습니다.",
      tags: "태그",
      folders: "폴더",
      myNotes: "내 노트",
      exporting: "내보내는 중...",
